...
function loadGoogleAnalytics() {
    ...
    script.async = true;
    script.src = 'https://www.googletagmanager.com/gtag/js?id=G-YSJEDDSZLC';
    document.head.appendChild(script);

    window.dataLayer = window.dataLayer || [];
    function gtag(){dataLayer.push(arguments);}
    gtag('js', new Date());
    gtag('config', 'G-YSJEDDSZLC', { 'anonymize_ip': true });
}
...
function initCookieConsent() {
    ...
    banner.innerHTML = `
        <p>We use cookies to analyze traffic and improve our website via Google Analytics. For more details, see our <a href="/datenschutz/">Privacy Policy</a>.</p>
